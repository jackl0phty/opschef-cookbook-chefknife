...
template "/usr/local/bin/chefknife" do
  ...
  mode 0755
  owner node.default['chefknife']['chefknife_binary_user']
  group node.default['chefknife']['chefknife_binary_group'] 
end

# Make sure /etc/chef dir exists.
directory "/etc/chef" do
  mode 0755
  owner node.default['chefknife']['chefknife_config_dir_user']
  group node.default['chefknife']['chefknife_config_dir_group']
